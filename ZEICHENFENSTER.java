...
public class ZEICHENFENSTER
{
    ...
    {
        this(titel, 1920, 1080, Color.white); 
    ...
    {
        graphic.setColor(Color.black);
        graphic.setFont(new Font("Lucida Bright", Font.PLAIN, 45));
        graphic.drawString(text, x, y);
        canvas.repaint();
    }
    
    public void zeichneTextHighlight(String text, int x, int y)
    {
        graphic.setColor(new Color(255,140,0));
        graphic.setFont(new Font("Lucida Bright", Font.ITALIC, 45));
        graphic.drawString(text, x, y);   
        canvas.repaint();        
    }
    
    public void zeichneTextPoints(String text, int x, int y)
    {
        graphic.setColor(new Color(254, 1, 154));
        graphic.setFont(new Font("Lucida Bright", Font.ITALIC, 45));
        graphic.drawString(text, x, y);   
        canvas.repaint();        
    }
